/**
 * I found this file online, which models ring, torus, cone, and cylinder.
 * I am using some of these objects to create different moving objects simpley to
 * increase the variaty of the objects in the environment and to be able to see
 * how the performace of the reflection mapping change if there is any.
 *
 * To be noted, this file does not include the models for cube and sphere.
 * These two are implemented in the file app.js, which I did in the similar
 * style as the ones in this file.
 */
